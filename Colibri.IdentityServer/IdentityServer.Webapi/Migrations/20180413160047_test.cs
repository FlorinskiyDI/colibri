        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Separation = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupNodes", x => new { x.AncestorId, x.OffspringId });
                    table.ForeignKey(
                        name: "FK_GroupNodes_ToAncestor",
                        column: x => x.AncestorId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupNodes_ToOffspring",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupNodes_OffspringId",
                table: "GroupNodes",
                column: "OffspringId");
