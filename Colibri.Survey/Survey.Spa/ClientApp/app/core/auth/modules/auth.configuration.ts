...
export class DefaultConfiguration {
    stsServer = 'http://localhost:44318';
    ...
    // Only for Google Auth with particular G Suite domain, see http://developers.google.com/identity/protocols/OpenIDConnect#hd-param
    hd_param = '';
    post_logout_redirect_uri = 'http://localhost:8080/unauthorized';
